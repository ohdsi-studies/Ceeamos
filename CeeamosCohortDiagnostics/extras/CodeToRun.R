...
# Load the package
library(CeeamosCohortDiagnostics)

path <- 's:/CeeamosCohortDiagnostics'
...
outputFolder <- "s:/CeeamosCohortDiagnostics/ccae"
...
CeeamosCohortDiagnostics::runCohortDiagnostics(connectionDetails = connectionDetails,
